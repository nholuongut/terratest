...
//
//	git::https://github.com/nholuongut/terratest.git//policies/foo.rego?ref=master
//
// The first time the nholuongut/terratest repo will be downloaded to a new temp directory. All subsequent calls will
// reuse that first temporary dir where the repo was cloned. This is preserved even if a different subdir is requested
// later, e.g.: git::https://github.com/nholuongut/terratest.git//examples/bar.rego?ref=master.
// Note that the query parameters are always included in the base URL. This means that if you use a different ref (e.g.,
// git::https://github.com/nholuongut/terratest.git//examples/bar.rego?ref=v0.39.3), then that will be cloned to a new
