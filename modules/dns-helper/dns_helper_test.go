...
// These are the current public nameservers for nholuongut.io domain
...
func TestOkTerratestDNSLookupAuthoritative(t *testing.T) {
	...
	expected := DNSAnswers{{"CNAME", "nholuongut-io.github.io."}}
