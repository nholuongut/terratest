...
func TestBuild(t *testing.T) {
	...
	tag := "nholuongut-io/test-image:v1"
	text := "Hello, World!"
...
func TestBuildWithBuildKit(t *testing.T) {
	...
	tag := "nholuongut-io/test-image-with-buildkit:v1"
	testToken := "testToken"
	options := &BuildOptions{
		Tags:           []string{tag},
		EnableBuildKit: true,
...
func TestBuildWithTarget(t *testing.T) {
	...
	tag := "nholuongut-io/test-image:target1"
	text := "Hello, World!"
...
func TestGitCloneAndBuild(t *testing.T) {
	...
	imageTag := "nholuongut-io-foo-test:" + uniqueID
	text := "Hello, World!"
	...
	GitCloneAndBuild(t, "git@github.com:nholuongut/terratest.git", gitBranchName, "test/fixtures/docker", buildOpts)
