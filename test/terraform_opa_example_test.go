...
import (
	...
	"github.com/nholuongut/terratest/modules/opa"
...
func TestOPAEvalTerraformModuleRemotePolicy(t *testing.T) {
	...
	opaOpts := &opa.EvalOptions{
		RulePath: "git::https://github.com/nholuongut/terratest.git//examples/terraform-opa-example/policy/enforce_source.rego?ref=master",
		FailMode: opa.FailUndefined,
	}
	terraform.OPAEval(t, tfOpts, opaOpts, "data.enforce_source.allow")
}
