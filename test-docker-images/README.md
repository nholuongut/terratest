# nholuongut Terratest Docker Images
...
We solve this problem by creating canonical nholuongut Terratest Docker Images which have most of the desired libraries
pre-installed. We upload these images to a public Docker Hub repo such as https://hub.docker.com/r/nholuongut/ubuntu-test/ so
...
```json
{
  "builders": [{
    ...
    "name": "ubuntu-docker",
    "type": "docker",
    "image": "nholuongut/ubuntu-test:18.04",
    "commit": "true"
  }],
  "provisioners": [
    // ...
