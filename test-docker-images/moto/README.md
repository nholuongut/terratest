...
This Docker image should publicly accessible via Docker Hub at https://hub.docker.com/r/nholuongut/moto/. To build and
upload it:

1. `docker build -t nholuongut/moto:v1 .`
1. `docker push nholuongut/moto:v1`

#### Run a Docker container

```
docker run -p 5000:5000 nholuongut/moto moto_server ec2 --host 0.0.0.0
```
