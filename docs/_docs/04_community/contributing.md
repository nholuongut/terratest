...
The documentation is built with Jekyll and hosted on the Github Pages from `docs` folder on `master` branch. Check out [Terratest website](https://github.com/nholuongut/terratest/tree/master/docs#working-with-the-documentation) to learn more about working with the documentation.
...
found [here](https://github.com/nholuongut/docs/community/contributing/#developing-terratest).
...
We have a [style guide](https://nholuongut.io/guides/style%20guides/golang-style-guide/) for the Go programming language,
...
1. Click `Run workflow` button and fill the fields in the drop down
    ...
    * _Name of the official terratest repo_ : home of the target pr (_nholuongut/terratest_)
...
code and release a new version, which you'll be able to find in the [releases page](https://github.com/nholuongut/terratest/releases).
...
along with the changelog, in the [Releases Page](https://github.com/nholuongut/terratest/releases).
