...
1. Copy the folder including all the files from the [basic terraform example](https://github.com/nholuongut/terratest/tree/master/examples/terraform-basic-example/) into the `examples` folder.

1. Copy the [basic terraform example test](https://github.com/nholuongut/terratest/blob/master/test/terraform_basic_example_test.go) into the `test` folder.
...
Terraform](https://blog.nholuongut.io/a-comprehensive-guide-to-terraform-b3d32832baca)): 
...
The above is just a small taste of what you can do with [Terratest](https://github.com/nholuongut/terratest). To 
learn more:
